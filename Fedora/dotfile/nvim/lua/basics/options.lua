...
vim.o.whichwrap = 'bshl'                                                -- Which "horizontal" keys are allowed to travel to prev/next line (default: 'b,s')
vim.o.numberwidth = 1                                                       -- Set number column width to 2 {default 4} (default: 4)
